...
$(function(){
	...
	//alert("---"+EasyEE.menuTreeJson);
	//普通树菜单初始化
	uiEx.initParentIdTree(
			"#menu",  //树菜单selector
			...
			.combobox(
					{
						...
						textField : 'text',
						method : 'get',
						url : "js/json/easyui.theme.combobox.json",
						/*
						...
						onSelect : function(selObj) {
							...
							document.getElementById("themeLink").href = "js/easyui/themes/"
									+ selObj.value
									+ "/easyui.css";
						...
						onLoadSuccess : function() {
							...
							if(theme){
							 ...
							 document.getElementById("themeLink").href="js/easyui/themes/"+defaultTheme+"/easyui.css";
						}
					});
